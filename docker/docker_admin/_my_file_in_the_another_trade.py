...
class Trading:
    @classmethod
    def find_the_offer_for_buyer(cls):
        ...
        if list_offer_buyer:
            for offer_buy in list_offer_buyer:
                ...
                if the_first_offer_seller and balance_offer_buy.balance > the_first_offer_seller.total_price_is_offer:
                    cls._make_trade_(offer_buy=offer_buy, the_first_offer_seller=the_first_offer_seller,
    ...
    @classmethod
    def _make_trade_(cls, offer_buy, the_first_offer_seller, balance_offer_sell, balance_offer_buy,
        ...
        cls.changes_to_create_trade(offer_buy=offer_buy,
    ...
    def if_the_buyer_has_more(cls, balance_offer_buy, balance_offer_sell, inventory_offer, inventory_offer_sell,
        ...
        if offer_buy.is_activate:
            cls.if_the_first_offer_do_not_covers_the_first_offer_of_seller(offer_buy=offer_buy,
    ...
    def if_the_first_offer_do_not_covers_the_first_offer_of_seller(cls, offer_buy, the_first_offer_seller):
        ...
        for offer_sell_if_the_first_offer_sell_not_covers in the_first_offer_seller:
            ...
            if not offer_sell_if_the_first_offer_sell_not_covers or not offer_buy.is_activate \
                    and balance_offer.balance > the_first_offer_seller.total_price_is_offer:
                cls._make_trade_if_the_first_offer_not_covers(offer_buy=offer_buy,
    ...
    @classmethod
    def _make_trade_if_the_first_offer_not_covers(cls, offer_buy, offer_sell_if_the_first_offer_sell_not_covers,
                                                  balance_offer,
                                                  balance_offer_sell, inventory_offer, inventory_offer_sell):
    ...
    @classmethod
    def if_seller_2_and_buyer_have_equal(cls, offer_sell_if_the_first_offer_sell_not_covers, offer_buy,
                                         balance_offer,
    ...
    def changes_job_a_trade(cls,
        ...
        if offer_buy.quantity > offer_sell_if_the_first_offer_sell_not_covers.quantity:
            ...
            cls.if_seller_2_and_buyer_have_equal(
                offer_sell_if_the_first_offer_sell_not_covers=offer_sell_if_the_first_offer_sell_not_covers,
                offer_buy=offer_buy,
                balance_offer_sell=balance_offer_sell,
                inventory_offer=inventory_offer,
    ...
    #
    @classmethod
    def if_seller_and_buyer_have_equal(cls, offer_buy, the_first_offer_seller, balance_offer_buy, balance_offer_sell,
                                       inventory_offer, inventory_offer_sell):
    ...
    @classmethod
    def changes_to_create_trade(cls, offer_buy,
                                the_first_offer_seller,
                                balance_offer_buy,
                                balance_offer_sell,
                                inventory_offer,
        ...
        if offer_buy.quantity > the_first_offer_seller.quantity:
            ...
            cls.if_seller_and_buyer_have_equal(offer_buy=offer_buy,
                                               the_first_offer_seller=the_first_offer_seller,
                                               balance_offer_sell=balance_offer_sell,
                                               balance_offer_buy=balance_offer_buy,
                                               inventory_offer=inventory_offer,
