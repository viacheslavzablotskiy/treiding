class Make_trades:
            ...
            for offer_buy in list_offer_buyer:
                ...
                if offer_seller:
                    ...
                    return cls.if_the_buyer_more_and_if_seller_more_and_the_buyer_and_the_seller_have_equal(
                        offer_buy=offer_buy, offer_seller=offer_seller, balance_offer_buy=balance_offer_buy,
        ...
        for offer_1 in offer_seller:
            ...
            if not offer_1 or not offer_buy.is_activate:
                ...
                return cls.if_the_offer_1_has_more_and_the_offer_buy_has_more_and_offer_1_and_offer_buy_have_equal(
                    offer_1=offer_1, balance_offer=balance_offer, balance_offer_sell=balance_offer_sell,
    ...
    def if_the_offer_1_has_more_and_the_offer_buy_has_more_and_offer_1_and_offer_buy_have_equal(cls, offer_1,
        ...
        if offer_buy.quantity > offer_1.quantity:
            return cls.the_offer_buy_has_more(offer_1=offer_1, offer_buy=offer_buy,
                                              balance_offer_sell=balance_offer_sell, inventory_offer=inventory_offer,
                                              inventory_offer_sell=inventory_offer_sell, balance_offer=balance_offer)
        elif offer_buy.quantity < offer_1.quantity:
            return cls.the_offer_1_has_more(offer_1=offer_1, offer_buy=offer_buy,
                                            balance_offer_sell=balance_offer_sell, inventory_offer=inventory_offer,
                                            inventory_offer_sell=inventory_offer_sell, balance_offer=balance_offer)
        elif offer_buy.quantity == offer_1.quantity:
            return cls.the_offer_1_and_offer_buy_have_equal(offer_1=offer_1, offer_buy=offer_buy,
    ...
    def if_the_buyer_more_and_if_seller_more_and_the_buyer_and_the_seller_have_equal(cls, offer_buy, offer_seller,
        ...
        if offer_buy.quantity > offer_seller.quantity:
            return cls.if_the_buyer_has_more(offer_buy=offer_buy, offer_seller=offer_seller,
            ...
            return cls.the_seller_has_more(offer_buy=offer_buy, offer_seller=offer_seller,
                                           balance_offer_sell=balance_offer_sell, balance_offer_buy=balance_offer_buy,
                                           inventory_offer=inventory_offer, inventory_offer_sell=inventory_offer_sell)
        elif offer_buy.quantity == offer_seller.quantity:
            return cls.the_buyer_and_seller_have_equal(offer_buy=offer_buy, offer_seller=offer_seller,
                                                       balance_offer_sell=balance_offer_sell,
